...
FPSCamera::~FPSCamera() { delete physicsEngine; }
...
void FPSCamera::setSceneInnerBoundary(float x1, float y1, float z1, float x2,
                                      float y2, float z2) {
...
void FPSCamera::updateView() {
  ...
  glm::mat4 matroll =
      glm::rotate(glm::mat4(1.0), -roll, glm::vec3(0.0f, 0.0f, 1.0f));
  glm::mat4 matpitch =
      glm::rotate(glm::mat4(1.0), -pitch, glm::vec3(1.0f, 0.0f, 0.0f));
  glm::mat4 matyaw =
      glm::rotate(glm::mat4(1.0), -yaw, glm::vec3(0.0f, 1.0f, 0.0f));
